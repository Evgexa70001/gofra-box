  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:title" content="Гофра-Тара | Производство картонных коробок" />
        <meta
        ...
        <meta property="og:url" content="https://gofra-box.vercel.app/" />

        {/* Twitter Card теги */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Гофра-Тара | Производство картонных коробок" />
        <meta
      ...
      <div className="min-h-screen bg-gray-100">
        ...
        <main className="max-w-[1280px] mx-auto px-4" role="main" aria-label="Основной контент">
          {children}
        </main>
