      ...
      <Helmet>
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            '@type': 'Organization',
            name: 'Гофра-Тара',
            url: 'https://gofra-box.vercel.app/',
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            ...
            <p className="text-gray-300 text-sm">
              ООО "Гофра-Тара" - производитель гофрированной упаковки и тары в России. Мы работаем с
              2010 года и специализируемся на производстве упаковочной продукции.
            </p>
          </div>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2 text-gray-300">
              <li>
                <a href="tel:+79289290689" className="hover:text-primary transition-colors">
                  +7 (928) 929-06-89
                </a>
              </li>

              <li>
                <a href="tel:+79283590689" className="hover:text-primary transition-colors">
                  +7 (928) 359-06-89
                </a>
              </li>

              <li>
                <a href="tel:+79280062126" className="hover:text-primary transition-colors">
                  +7 (928) 006-21-26
                </a>
              </li>
              <li>График работы:</li>
          ...
          <div className="col-span-1">
            ...
            <address className="text-gray-300 not-italic">
              ...
              <p>ул. Ленина, д. 46</p>
              <p className="mt-2 text-sm">Производство и офис находятся по одному адресу</p>
            </address>
          </div>
          ...
          <div className="col-span-1">
            ...
            <p className="mt-4 text-sm text-gray-300">Наши социальные сети, для связи с нами</p>
          </div>
        </div>
