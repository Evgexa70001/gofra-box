  ...
  return (
    <HelmetProvider>
      <SEO
        ...
        canonicalUrl={`https://gofra-box.vercel.app/product/${product.id}`}
      />
      ...
      <article className="max-w-7xl mx-auto px-4 py-8" aria-labelledby="product-title">
        <div className="bg-white rounded-xl shadow-lg p-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div className="space-y-8">
              <h1 id="product-title" className="text-3xl font-bold text-gray-900">
                {product.название}
              </h1>
            ...
            <div className="space-y-6">
              <div
                ...
                role="region"
                aria-label="Цены в зависимости от количества">
                <h2 className="text-xl font-semibold text-gray-900 mb-4">Стоимость за штуку</h2>
                <div className="space-y-4">
                  {priceBreakdown.map((tier, index) => (
                    <div
                      key={index}
                      className="flex justify-between items-center"
                      aria-label={`От ${tier.quantity} штук: ${tier.price} рублей`}>
                      <span className="text-gray-600">от {tier.quantity} шт.</span>
                ...
                <p className="mt-4 text-sm text-gray-500">* Цены указаны с учетом оптовых скидок</p>
              </div>
              ...
              <div className="pt-2">
                ...
                <dl className="grid grid-cols-2 gap-4" aria-label="Характеристики товара">
                  <div>
                  ...
                  <div>
                    ...
                    <dd className="text-base font-medium text-gray-900">{product.типКартона}</dd>
                  </div>
                  <div>
                    <dt className="text-sm text-gray-500">Материал</dt>
                    <dd className="text-base font-medium text-gray-900">{product.марка}</dd>
                  </div>
                  <div>
                    <dt className="text-sm text-gray-500">Категория</dt>
                    <dd className="text-base font-medium text-gray-900">{product.категория}</dd>
                  </div>
                  <div>
